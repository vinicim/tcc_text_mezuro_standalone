...
CHAPTERS_SOURCES = 1-introducao.tex 2-metodos_empiricos.tex \
				   3-evolucao_software.tex 4-melhoria_experiencia_usuario.tex \
				   5-arquitetura.tex 6-mezuro.tex 7-consideracoes.tex
