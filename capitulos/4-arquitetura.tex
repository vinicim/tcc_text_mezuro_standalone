...
Os relacionamentos entre os elementos também estão inclusos, e também compõem o aspecto estático da arquitetura do sistema \cite{germoglio2010fundamentos}. A Figura~\ref{fig:rails-architecture} representa os elementos estáticos da arquitetura do Rails.
...
%TODO: concluir algo ainda aqui para o TCC 1
