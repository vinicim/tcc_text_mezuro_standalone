...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{figuras/figuraCDRBR.eps}
...
\begin{figure}[htpb]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{figuras/FiguraTraducao1Color.eps}
    \caption{Ciclo das tarefas de usabilidade x desenvolvimento \cite{lee2011}}
...
%
\item Moreno e Yagüe (\citeyear{moreno2012}) trás em seu trabalho a inserção da usabilidade por meio da criação de \textit{User Stories} de usabilidade que denominam de \textit{Usability Stories}. Tendo que especificar os recursos funcionais de usabilidade que serão utilizados no projeto, o artigo trás um tabela que é necessária para definir as características dessa funcionalidade.
